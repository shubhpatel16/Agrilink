    ...
    <>
      <div className={`${styles.section}`}>
        <div className="flex 800px:h-[500px] 800px:my-[20px] 800px:flex items-center justify-between">
          {/* <div className="hidden 800px:h-[500px] 800px:my-[20px] 800px:flex items-center justify-between"> */}
          <div>
            <Link to="/">
          ...
          <div className="w-[50%] relative">
            ...
            {searchData && searchData.length !== 0 ? (
              <div className="absolute min-w-[95vh] bg-green-50 shadow-sm-2 z-[9] p-4">
                {searchData &&
      ...
      >
        ...
        className={`${
          active === true ? "shadow-sm fixed top-0 left-0 z-10" : null
        } transition hidden 800px:flex items-center justify-between w-full bg-[#58942c] h-[70px]`}>
        */}
        <div
