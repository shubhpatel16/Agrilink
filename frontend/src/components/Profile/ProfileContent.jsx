...
const Address = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!addressType || !country || !state || !city || !zipCode || !address1) {
  ...
  return (
    <div className="w-full px-5 ">
      ...
      <div className="flex w-full items-center justify-between ">
        <h1 className="text-[25px] font-[600] text-[#000000ba] pb-2 flex items-center">
          <TbAddressBook size={45} className="mr-2" />
          My Addresses
        </h1>
      ...
      {user &&
        user.addresses.map((item, index) => (
          <div
            className="w-full bg-white h-[70px] 800px:h-min rounded-[4px] flex items-center px-3 shadow justify-between pr-10 mb-5"
            // <div
