...
function ResponsiveAppBar() {
  ...
  return (
    <AppBar position="static" className="responsiveappbar" sx={{ backgroundColor: 'green', marginTop: '80px' }}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <img src={logo} alt="Logo" style={{ height: '40px', marginRight: '10px' }} /> {/* Add your logo here */}
          <Typography
            variant="h6"
            noWrap
            component="a"
